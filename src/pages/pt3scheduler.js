        ...
        <div className="appCont">
          ...
          <div class="appBody">
            <p className="text notHidden">
              ...
              that would allow for scheduling of appointments between a
              contractor and client completly online. As with many things in the
              busy lifestyle that people lead, one doesn't always have time for
              a phone conversation just for setting an appointment. This app
              seeks to remedy this situation and provide an intuitive interface
              for both parties in the transaction in regards to scheduling and
              appointments.
            </p>
          </div>
